...
public class DeleteFeePaymentServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<html><head><title>Delete Payment</title>");
            out.println("<style>");
            ...
            out.println("<h1>Delete Payment</h1>");

            if(i > 0)
                out.println("<div class='msg'>Payment Deleted Successfully</div>");
            else
                out.println("<div class='msg'>ID Not Found</div>");
